-- Apply New Features - Minimal Version
-- This script applies the 4 new features with minimal sample data to avoid constraint issues
...
-- 5. Fix existing data
-- Update existing NULL values in asset_initiatives
...
-- 6. Insert minimal sample data (just one record to test)
