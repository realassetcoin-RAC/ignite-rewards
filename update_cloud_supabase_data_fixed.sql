-- =====================================================
-- RAC Rewards - Cloud Supabase Database Update Script (FIXED)
...
-- Using existing table structure: id, name, description, price_monthly, price_yearly, monthly_points, monthly_transactions, features, trial_days, is_active, popular, plan_number, created_at, updated_at
INSERT INTO public.merchant_subscription_plans (
    name, description, price_monthly, price_yearly, monthly_points, 
    monthly_transactions, features, trial_days, is_active, popular, plan_number
) VALUES 
...
CREATE INDEX IF NOT EXISTS idx_merchant_subscription_plans_popular ON public.merchant_subscription_plans(popular);
