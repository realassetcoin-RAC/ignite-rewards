-- Update the DAO trigger to use the new 5 main DAO organizations
-- =====================================================

-- First, create the loyalty_change_requests table if it doesn't exist
...
DROP FUNCTION IF EXISTS public.create_dao_proposal_for_loyalty_change();

-- Create updated function that uses the new DAO mapping
