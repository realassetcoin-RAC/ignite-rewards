-- =====================================================
-- RAC Rewards - Supabase Database Update Script (EXACT MATCH)
-- Updates merchant subscription plans and loyalty NFT cards as per cursor rules
-- Matches the EXACT table structure from your database
-- =====================================================
...
-- Step 3: Insert NFT Types (Using EXACT column structure)
-- =====================================================
...
INSERT INTO public.nft_types (
    ...
    evolution_earnings_ratio, passive_income_rate, custodial_income_rate,
    subscription_plan, pricing_type, one_time_fee, monthly_fee, annual_fee,
    is_custodial, is_active, evolution_image_url, image_url, description
) VALUES 
-- Pearl White (Custodial) - Free
(
    'Pearl White', 'Pearl White', 0.00, 'Common', 10000, 
    true, true, true, 'Forever',
    0.0100, 0.0000, 100.00, 0.0025, 0.0100, 0.0000,
    'Free', 'One-time', 0.00, 0.00, 0.00,
    true, true, 
    'https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=400',
    'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400',
    'Free Pearl White loyalty card for custodial users with basic earning capabilities.'
),

-- Lava Orange (Custodial)
(
    'Lava Orange', 'Lava Orange', 100.00, 'Less Common', 3000, 
    true, true, true, 'Forever',
    0.0110, 0.0010, 500.00, 0.0050, 0.0110, 0.0000,
    'Free', 'One-time', 100.00, 0.00, 0.00,
    true, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=400',
    'Lava Orange loyalty card with enhanced earning capabilities and upgrade bonuses.'
),

-- Pink (Custodial)
(
    'Pink', 'Pink', 100.00, 'Less Common', 3000, 
    true, true, true, 'Forever',
    0.0110, 0.0010, 500.00, 0.0050, 0.0110, 0.0000,
    'Free', 'One-time', 100.00, 0.00, 0.00,
    true, true,
    ...
    'Pink loyalty card with enhanced earning capabilities and upgrade bonuses.'
),

-- Silver (Custodial)
(
    'Silver', 'Silver', 200.00, 'Rare', 750, 
    true, true, true, 'Forever',
    0.0120, 0.0015, 1000.00, 0.0075, 0.0120, 0.0000,
    'Free', 'One-time', 200.00, 0.00, 0.00,
    true, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=400',
    'Silver loyalty card with premium earning capabilities and significant upgrade bonuses.'
),

-- Gold (Custodial)
(
    'Gold', 'Gold', 300.00, 'Rare', 750, 
    true, true, true, 'Forever',
    0.0130, 0.0020, 1500.00, 0.0100, 0.0130, 0.0000,
    'Free', 'One-time', 300.00, 0.00, 0.00,
    true, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1544441893-675973e31985?w=400',
    'Gold loyalty card with premium earning capabilities and significant upgrade bonuses.'
),

-- Black (Custodial)
(
    'Black', 'Black', 500.00, 'Very Rare', 250, 
    true, true, true, 'Forever',
    0.0140, 0.0030, 2500.00, 0.0125, 0.0140, 0.0000,
    'Free', 'One-time', 500.00, 0.00, 0.00,
    true, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1555274175-6cbf6f3b137b?w=400',
    'Black loyalty card with elite earning capabilities and maximum upgrade bonuses.'
),

-- Non-Custodial NFT Types (For users with external wallets)
-- Pearl White (Non-Custodial)
(
    'Pearl White (Non-Custodial)', 'Pearl White (Non-Custodial)', 100.00, 'Common', 10000, 
    false, true, true, 'Forever',
    0.0100, 0.0000, 500.00, 0.0050, 0.0100, 0.0000,
    'Premium', 'One-time', 100.00, 0.00, 0.00,
    false, true,
    'https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=400',
    'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400',
    'Pearl White loyalty card for non-custodial users with external wallet integration.'
),

-- Lava Orange (Non-Custodial)
(
    'Lava Orange (Non-Custodial)', 'Lava Orange (Non-Custodial)', 500.00, 'Less Common', 3000, 
    false, true, true, 'Forever',
    0.0110, 0.0000, 2500.00, 0.0125, 0.0110, 0.0000,
    'Premium', 'One-time', 500.00, 0.00, 0.00,
    false, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=400',
    'Lava Orange loyalty card for non-custodial users with enhanced earning capabilities.'
),

-- Pink (Non-Custodial)
(
    'Pink (Non-Custodial)', 'Pink (Non-Custodial)', 500.00, 'Less Common', 3000, 
    false, true, true, 'Forever',
    0.0110, 0.0000, 2500.00, 0.0125, 0.0110, 0.0000,
    'Premium', 'One-time', 500.00, 0.00, 0.00,
    false, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1580894736036-1d3b4b9d3ad4?w=400',
    'Pink loyalty card for non-custodial users with enhanced earning capabilities.'
),

-- Silver (Non-Custodial)
(
    'Silver (Non-Custodial)', 'Silver (Non-Custodial)', 1000.00, 'Rare', 750, 
    false, true, true, 'Forever',
    0.0120, 0.0000, 5000.00, 0.0015, 0.0120, 0.0000,
    'Premium', 'One-time', 1000.00, 0.00, 0.00,
    false, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=400',
    'Silver loyalty card for non-custodial users with premium earning capabilities.'
),

-- Gold (Non-Custodial)
(
    'Gold (Non-Custodial)', 'Gold (Non-Custodial)', 1000.00, 'Rare', 750, 
    false, true, true, 'Forever',
    0.0130, 0.0000, 5000.00, 0.0020, 0.0130, 0.0000,
    'Premium', 'One-time', 1000.00, 0.00, 0.00,
    false, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1544441893-675973e31985?w=400',
    'Gold loyalty card for non-custodial users with premium earning capabilities.'
),

-- Black (Non-Custodial)
(
    'Black (Non-Custodial)', 'Black (Non-Custodial)', 2500.00, 'Very Rare', 250, 
    false, true, true, 'Forever',
    0.0140, 0.0000, 13500.00, 0.0030, 0.0140, 0.0000,
    'Premium', 'One-time', 2500.00, 0.00, 0.00,
    false, true,
    'https://images.unsplash.com/photo-1634973357973-f2ed2657db3c?w=400',
    'https://images.unsplash.com/photo-1555274175-6cbf6f3b137b?w=400',
    'Black loyalty card for non-custodial users with elite earning capabilities.'
);
...
-- Show all NFT types by custodial status
SELECT 
    nft_name,
    display_name,
    rarity,
