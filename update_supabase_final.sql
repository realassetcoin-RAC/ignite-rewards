-- =====================================================
-- RAC Rewards - Supabase Database Update Script (FINAL)
-- Updates merchant subscription plans and loyalty NFT cards as per cursor rules
-- Handles both existing and new table creation
-- =====================================================
...
-- Delete existing NFT types (if table exists)
DO $$
BEGIN
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'nft_types') THEN
...
-- Step 3: Create NFT Types Table (if it doesn't exist) and Insert Data
-- =====================================================

-- Create nft_types table with all required columns as per cursor rules
