-- ===========================================
-- DAO TABLES CREATION ONLY (SAFE VERSION)
-- ===========================================
-- This script only creates the missing DAO tables without any data insertion
...
SELECT '✅ DAO TABLES CREATION COMPLETED!' as message;
