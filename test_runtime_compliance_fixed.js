...
async function testRuntimeComplianceFixed() {
  console.log('🧪 Testing Runtime Compliance with Docker PostgreSQL Database (Fixed Schema)\n');
  ...
  try {
    ...
    try {
      ...
      // Test loyalty card creation with proper UUID
      const testUserId = '00000000-0000-0000-0000-000000000001'; // Use proper UUID format
      ...
      `, [
        testUserId,
        '00000000-0000-0000-0000-000000000002', // Use proper UUID format
        loyaltyNumber,
    ...
    // 4. Test OTP Operations (Fixed Schema)
    ...
    try {
      ...
      // Test OTP insertion with correct schema
      ...
      const otpInsertResult = await client.query(`
        ...
        RETURNING id
      `, [
        '00000000-0000-0000-0000-000000000001', // Use proper UUID
        '00000000-0000-0000-0000-000000000002', // Use proper UUID
        '+1234567890',
        testOtpCode,
    ...
    // 5. Test Wallet Operations (Fixed Schema)
    ...
    try {
      ...
      // Test wallet creation with correct schema
      const testWalletUserId = '00000000-0000-0000-0000-000000000003'; // Use proper UUID
      ...
      console.log(`✅ Created Solana wallet: ${wallet.id} - ${wallet.public_key}`);
    ...
    // 6. Test Investment Features (Fixed Schema)
    ...
    try {
      ...
      // Test investment creation with correct schema
      const testInvestmentUserId = '00000000-0000-0000-0000-000000000004'; // Use proper UUID
      const investmentInsertResult = await client.query(`
        INSERT INTO asset_investments (
          ...
          transaction_hash, wallet_address, status
        ) VALUES ($1, $2, $3, $4, $5, $6, $7)
        RETURNING id, investment_amount, currency_type
      `, [
        testInvestmentUserId,
        initiativesResult.rows[0]?.id || '00000000-0000-0000-0000-000000000005',
        100.50,
        'USDT',
    ...
    // 8. Test Terms/Privacy Acceptance (Fixed Schema)
    ...
    try {
      ...
      // Test terms acceptance creation with correct schema
      const testTermsUserId = '00000000-0000-0000-0000-000000000006'; // Use proper UUID
