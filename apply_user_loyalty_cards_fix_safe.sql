-- SAFE VERSION: Apply this SQL directly in your Supabase dashboard SQL editor
-- This version handles the existing table properly and migrates data safely
...
-- Drop any existing api function first
DROP FUNCTION IF EXISTS api.generate_loyalty_number(TEXT);
DROP FUNCTION IF EXISTS api.generate_loyalty_number();
