...
async function testWithExistingData() {
  console.log('🧪 Testing Runtime Compliance with Existing Database Data\n');
  ...
  try {
    ...
    // Get existing valid IDs first
    console.log('🔍 Finding existing valid IDs...');
    ...
    try {
      ...
      // Test loyalty card creation with valid foreign keys
    ...
    try {
      ...
      // Test OTP insertion with valid foreign keys
    ...
    try {
      ...
      // Test investment creation with valid status
    ...
    try {
      ...
      // Test terms acceptance creation with valid user ID
