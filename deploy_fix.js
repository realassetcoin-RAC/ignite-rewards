...
async function deployFix() {
  ...
  try {
    ...
    // Set admin role for the user (you'll need to update this with your actual email)
    console.log('');
    console.log('👑 Setting up admin user...');
    console.log('   Note: You may need to update your email in the admin setup');
    
    // We'll create a generic admin setup that can be customized
    const adminSetup = await client.query(`
      -- This creates a placeholder admin setup
      -- You should update this with your actual email after logging in
    ...
    console.log('   2. Update your user role to admin by running:');
