-- Add email limits and points caps to merchant subscription plans
-- This migration adds plan-specific limits for email addresses and monthly points distribution
