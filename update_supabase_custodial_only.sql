-- =====================================================
-- RAC Rewards - Supabase Database Update Script (CUSTODIAL NFTs ONLY)
-- Updates merchant subscription plans and CUSTODIAL loyalty NFT cards only
...
-- Step 3: Insert CUSTODIAL NFT Types ONLY (Using EXACT column structure)
-- =====================================================

-- Insert ONLY Custodial NFT Types (Free for users with custodial wallets)
...
-- Verify NFT types (should show only custodial)
SELECT 
...
-- Show all NFT types (should show only 6 custodial)
SELECT 
    nft_name,
    display_name,
    rarity,
