-- Complete Database Setup - Creates everything from scratch
-- Copy and paste this entire script into your Supabase SQL Editor

-- ===========================================
-- 0. CLEAN UP EXISTING CONFLICTING OBJECTS
-- ===========================================
...
DROP TRIGGER IF EXISTS create_user_referral_code ON auth.users CASCADE;

-- Drop any existing tables that might conflict
DROP TABLE IF EXISTS public.user_referrals CASCADE;

-- ===========================================
-- 1. CREATE MERCHANTS TABLE (if not exists)
-- ===========================================
...
-- ===========================================
-- 2. CREATE MERCHANT_SUBSCRIPTION_PLANS TABLE
-- ===========================================
...
-- ===========================================
-- 5. CREATE TEST USERS FIRST
-- ===========================================

-- Create test users in auth.users table
-- Note: We'll use a simpler approach to avoid triggering problematic functions
