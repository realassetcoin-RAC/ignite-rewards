-- ===========================================
-- COMPREHENSIVE TEST DATA FOR REWARDS APPLICATION (CORRECTED V2)
-- ===========================================
...
-- 
-- IMPORTANT: Run fix-test-data-issues-corrected-v3.sql FIRST before running this script
...
-- We'll use the first available plan for each merchant
