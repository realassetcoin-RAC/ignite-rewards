# Run All Database Scripts from Past 10 Days on Local PostgreSQL
# This script executes all the important database scripts on your local database

Write-Host "================================================================================" -ForegroundColor Cyan
Write-Host "RAC Rewards - Execute All Database Scripts (Past 10 Days)" -ForegroundColor Cyan
Write-Host "================================================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Executing $totalScripts database scripts..." -ForegroundColor Yellow
Write-Host ""
