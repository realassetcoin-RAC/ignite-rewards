-- Complete Final Fix - Address All Remaining Issues
-- This script fixes all remaining database issues

-- First, let's check what tables exist and their schemas
-- Drop all problematic tables and recreate them with correct schemas

-- Drop all tables that might have wrong schemas
