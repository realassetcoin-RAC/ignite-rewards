...
const logger = createModuleLogger('SolanaWalletService');
...
export class SolanaWalletService {
  /**
   * Generate a new Solana keypair and seed phrase
   */
  private static generateKeypair(): { keypair: Keypair; seedPhrase: string[] } {
    const keypair = Keypair.generate();
    
    // Generate a 12-word seed phrase (this is a simplified version)
    // In production, you'd use a proper BIP39 implementation
    const seedPhrase = this.generateSeedPhrase();
    
    return { keypair, seedPhrase };
  }
  ...
  private static generateSeedPhrase(): string[] {
    const words = [
      ...
      'cereal', 'certain', 'chair', 'chalk', 'champion', 'change', 'chaos', 'charge', 'chase', 'cheap',
      ...
      'civil', 'claim', 'clamp', 'clarify', 'claw', 'clay', 'clean', 'clerk', 'clever', 'click',
      'client', 'cliff', 'climb', 'cling', 'clinic', 'clip', 'clock', 'clog', 'close', 'cloth',
      ...
      'duck', 'dumb', 'dune', 'during', 'dusk', 'dust', 'dutch', 'duty', 'dwarf', 'dynamic',
      ...
      'enemy', 'energy', 'enforce', 'engage', 'engine', 'enjoy', 'enlist', 'enough', 'enrich', 'enroll',
      ...
      'find', 'fine', 'finger', 'finish', 'fire', 'firm', 'first', 'fiscal', 'fish', 'fist',
      ...
      'harsh', 'harvest', 'hash', 'hat', 'have', 'hawk', 'hazard', 'head', 'health', 'heart',
      ...
      'know', 'lab', 'label', 'labor', 'ladder', 'lady', 'lake', 'lamp', 'land', 'landscape',
      'lane', 'language', 'laptop', 'large', 'later', 'latin', 'laugh', 'laundry', 'lava', 'law',
      ...
      'must', 'mutual', 'myself', 'mystery', 'naive', 'name', 'napkin', 'narrow', 'nasty', 'nation',
      ...
      'order', 'ordinary', 'organ', 'orient', 'original', 'orphan', 'ostrich', 'other', 'our', 'ours',
      'ourselves', 'out', 'outdoor', 'outer', 'outline', 'outlook', 'outstanding', 'oval', 'oven', 'over',
      ...
      'pitch', 'pizza', 'place', 'plate', 'play', 'please', 'pledge', 'pluck', 'plug', 'plunge',
      'poem', 'poet', 'point', 'polar', 'pole', 'police', 'pond', 'pony', 'pool', 'poor',
      'pop', 'popcorn', 'popular', 'portion', 'position', 'possible', 'post', 'potato', 'pottery', 'poverty',
      ...
      'recipe', 'record', 'recover', 'recruit', 'red', 'reduce', 'reflect', 'reform', 'refuse', 'region',
      ...
      'shine', 'ship', 'shiver', 'shock', 'shoe', 'shoot', 'shop', 'shore', 'short', 'shoulder',
      'shove', 'shrimp', 'shrug', 'shy', 'sibling', 'sick', 'side', 'siege', 'sight', 'sign',
      ...
      'slow', 'slump', 'slung', 'slurp', 'slush', 'sly', 'smack', 'small', 'smart', 'smile',
      'smoke', 'smooth', 'smuggle', 'snack', 'snake', 'snap', 'snare', 'snarl', 'sneak', 'sneeze',
      'sniff', 'snore', 'snort', 'snout', 'snow', 'snub', 'snuff', 'snug', 'soak', 'soap',
      'soar', 'sob', 'sober', 'soccer', 'social', 'sock', 'soda', 'sofa', 'soft', 'soggy',
      'soil', 'solar', 'soldier', 'solid', 'solo', 'solve', 'someone', 'song', 'soon', 'sorry',
      'sort', 'soul', 'sound', 'soup', 'sour', 'south', 'sow', 'soy', 'space', 'spare',
      'spark', 'sparse', 'spatial', 'spawn', 'speak', 'speed', 'spell', 'spend', 'sphere', 'spice',
      'spider', 'spike', 'spin', 'spirit', 'split', 'splurge', 'spoil', 'sponsor', 'spoon', 'sport',
      'spot', 'spouse', 'spray', 'spread', 'spring', 'sprout', 'spruce', 'spy', 'square', 'squash',
      'squeeze', 'squirrel', 'stab', 'stable', 'stadium', 'staff', 'stage', 'stairs', 'stamp', 'stand',
      'start', 'state', 'stay', 'steak', 'steal', 'steam', 'steel', 'steep', 'stem', 'step',
      'stereo', 'stick', 'still', 'sting', 'stock', 'stomach', 'stone', 'stool', 'stoop', 'stop',
      'store', 'storm', 'story', 'stove', 'straddle', 'straight', 'strain', 'strand', 'strange', 'stranger',
      'strap', 'straw', 'stream', 'street', 'strength', 'stress', 'stretch', 'strict', 'stride', 'strike',
      'string', 'strive', 'stroke', 'stroll', 'strong', 'struggle', 'strut', 'stuck', 'student', 'stuff',
      'stump', 'stun', 'stunt', 'style', 'subdue', 'subject', 'submit', 'subway', 'succeed', 'such',
      'sudden', 'suffer', 'sugar', 'suggest', 'suit', 'sulk', 'sultry', 'summer', 'sun', 'sunny',
      'sunset', 'super', 'supply', 'supreme', 'sure', 'surface', 'surge', 'surprise', 'surround', 'survey',
      'suspect', 'sustain', 'swallow', 'swamp', 'swap', 'swarm', 'sway', 'swear', 'sweat', 'sweep',
      'sweet', 'swell', 'swift', 'swim', 'swing', 'switch', 'sword', 'symbol', 'symptom', 'syrup',
      'system', 'table', 'tackle', 'tag', 'tail', 'talent', 'talk', 'tall', 'tank', 'tape',
      ...
      'tick', 'tide', 'tidy', 'tie', 'tiger', 'tight', 'tile', 'till', 'tilt', 'timber',
      'time', 'timid', 'tin', 'tiny', 'tip', 'tire', 'tired', 'tissue', 'title', 'to',
      'toast', 'today', 'toddler', 'toe', 'together', 'toilet', 'token', 'tomato', 'tomorrow', 'tone',
      'tongue', 'tonight', 'too', 'tool', 'tooth', 'top', 'topic', 'topple', 'torch', 'tornado',
      'tortoise', 'toss', 'total', 'touch', 'tough', 'tour', 'toward', 'tower', 'town', 'toy',
      ...
      'under', 'undo', 'unfair', 'unfold', 'unhappy', 'unhealthy', 'uniform', 'unique', 'unit', 'universe',
      'unknown', 'unlock', 'until', 'unusual', 'unveil', 'update', 'upgrade', 'uphold', 'upon', 'upper',
      'upright', 'upset', 'urban', 'urge', 'usage', 'use', 'used', 'useful', 'useless', 'usual',
      'utility', 'vacant', 'vacuum', 'vague', 'valiant', 'valid', 'valley', 'valve', 'van', 'vanish',
      ...
      'wait', 'wake', 'walk', 'wall', 'walnut', 'want', 'war', 'warm', 'warn', 'wash',
      'wasp', 'waste', 'water', 'wave', 'way', 'weak', 'wealth', 'weapon', 'wear', 'weasel',
      'weather', 'web', 'wedding', 'weed', 'week', 'weird', 'welcome', 'west', 'wet', 'whale',
      'what', 'wheat', 'wheel', 'when', 'where', 'whip', 'whisper', 'white', 'who', 'whole',
      'whom', 'whose', 'why', 'wicked', 'wide', 'widow', 'width', 'wife', 'wild', 'will',
      'win', 'window', 'wine', 'wing', 'wink', 'winner', 'winter', 'wire', 'wisdom', 'wise',
      'wish', 'witness', 'wolf', 'woman', 'wonder', 'wood', 'wool', 'word', 'work', 'world',
      'worry', 'worth', 'would', 'wrap', 'wreck', 'wrestle', 'wrist', 'write', 'wrong', 'yard',
   ...
   */
  static async createWalletForUser(userId: string): Promise<WalletCreationResult> {
    try {
      logger.info(`Creating Solana wallet for user: ${userId}`);

      // Generate new keypair and seed phrase
      const { keypair, seedPhrase } = this.generateKeypair();
      
      // Encrypt private key and seed phrase (simplified for demo)
      const privateKeyEncrypted = this.encryptData(keypair.secretKey.toString());
      const seedPhraseEncrypted = this.encryptData(JSON.stringify(seedPhrase));
      
      // Generate a simple IV for demo purposes (in production, use proper crypto.randomBytes)
      const iv = btoa(Date.now().toString() + Math.random().toString());
      ...
      if (error) {
        logger.error('Error creating wallet in database:', error);
        return {
          success: false,
      ...
      logger.info(`✅ Solana wallet created successfully for user: ${userId}`);
      ...
      logger.error('Error creating Solana wallet:', error);
      return {
        success: false,
   ...
   */
  static async getUserWallet(userId: string): Promise<SolanaWallet | null> {
    try {
      const { data, error } = await databaseAdapter.supabase
        .from('user_solana_wallets')
        .select('*')
      ...
      // Return the first wallet if found, otherwise null
  ...
  /**
   * Decrypt and return user's seed phrase
   */
  static async getUserSeedPhrase(userId: string): Promise<string[] | null> {
    try {
      ...
      const decryptedSeedPhrase = this.decryptData(wallet.seed_phrase_encrypted);
      return JSON.parse(decryptedSeedPhrase);
    } catch (error) {
      logger.error('Error decrypting seed phrase:', error);
      return null;
    }
  }
