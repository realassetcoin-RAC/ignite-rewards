...
const UserDashboardSimple = () => {
  const { user, profile, signOut, loading, error } = useSecureAuth();
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mt-2">This may take a moment if the database is temporarily unavailable</p>
        </div>
      </div>
    );
  }
        ...
        <main className="p-6">
          ...
          {error && (
            <div className="max-w-7xl mx-auto mb-6">
              <Card className="bg-yellow-500/10 border-yellow-500/20 backdrop-blur-xl">
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-yellow-400">Limited Mode</h3>
