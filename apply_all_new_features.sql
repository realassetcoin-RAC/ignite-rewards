...
-- 4. Create asset investment transactions table
...
-- RLS Policies for merchant_custom_nfts
...
DO $$
BEGIN
    -- Insert sample merchant custom NFT if no data exists
    ...
    -- Insert sample asset wallet if no data exists
